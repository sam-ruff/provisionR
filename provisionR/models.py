...
class GlobalConfig(BaseModel):
    ...
    target_os: TargetOS = Field(default=TargetOS.ROCKY9, description="Target operating system")
    generate_passwords: bool = Field(default=True, description="Whether to auto-generate passwords")
    values: Dict[str, Any] = Field(default_factory=dict, description="Custom key-value pairs available during templating")
